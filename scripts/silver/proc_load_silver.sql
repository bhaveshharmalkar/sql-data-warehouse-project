...
BEGIN
	...
	INSERT INTO silver.crm_cust_info (
		...
		CASE WHEN UPPER(TRIM(cst_marital_status)) = 'M' THEN 'Married'
			...
			ELSE 'n/a' 
		END cst_marital_status,   -- Normalize marital status val	ues to readable format
	...
	INSERT INTO silver.crm_prd_info (
		...
		SELECT
			...
			CASE WHEN UPPER(TRIM(prd_line)) = 'R' THEN 'Road'
				...
				ELSE 'n/a'
			END AS prd_line, -- Map product line code as decriptive values
	...
	INSERT INTO silver.crm_sales_details(
		...
		SELECT
			...
			CASE 
				...
				ELSE sls_sales
			END sls_sales,	-- Recalculate sales if values is missing or incorrect
			sls_quantity,
			CASE 
				WHEN sls_price IS NULL OR sls_price <= 0
					THEN sls_sales / NULLIF(sls_quantity, 0)
				ELSE sls_price
			END sls_price	-- Derive price if original values is invalid
	...
	INSERT INTO silver.erp_cust_az12(
		...
		SELECT
			...
			CASE 
				...
				ELSE 'n/a'
			END gen	-- Normalize gender values to handle unknown cases
		FROM
